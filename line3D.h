...
namespace L3DPP
{
    ...
    public:
        ...
        Line3D(const std::string& output_folder,
               ...
               const std::string& inputFolderMatches,
        ...
        void writeFile_line(const unsigned int id_cam, std::vector<Eigen::Vector4f> segments2d);
        ...
        void computeMedianDepth();
        std::vector<std::vector<float> > ComputeWorlpointDepth();
    ...
    private:
        ...
        void matchingCPU_epipolar(const unsigned int src, const unsigned int tgt,
                         const Eigen::Matrix3d& F);
        ...
        std::string data_input_folder_;
        std::string data_matches_folder_;
        std::string prefix_;
        ...
        std::vector<std::vector<float>> matrix_med;
